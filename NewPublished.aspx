<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPublished.aspx.cs" Inherits="finalyearproject.NewPublished" %>


<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <title>The Reader's Gateway - User Can Publish</title>
            ...
            <div class="container header-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8 text-center">
                        ...
                        <h2 class="h4">User can publish</h2>
                    </div>
                    <div class="col-lg-2 text-center text-lg-end">
                        <asp:HyperLink ID="lnkBack" runat="server" CssClass="btn btn-light" NavigateUrl="~/homepage.aspx">
                ...
                <div class="col-lg-10">
                    <div class="card animate__animated animate__fadeInUp">
                        ...
                        <div class="card-header">
                            <i class="fas fa-star me-2"></i>Book Details
                        </div>
                        <div class="card-body">
                            <!-- Basic Information -->
            ...
            <asp:DropDownList ID="ddlGenre" runat="server" CssClass="form-select"  AutoPostBack="true">
                ...
                <asp:ListItem Value="Travel">Travel</asp:ListItem>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                                <asp:Button ID="btnSubmit" runat="server" Text="Publish" 
