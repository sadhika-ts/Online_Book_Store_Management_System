<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBooks.aspx.cs" Inherits="finalyearadmin.AddBooks" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <title>The Reader's Gateway - Add Books</title>
                    ...
                    <div class="card animate__animated animate__fadeInUp">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="txtPublishDate" class="form-label">Publish Date</label>
                                    <div class="position-relative">
          ...
          <div class="input-group">
              ...
              <asp:DropDownList ID="ddlGenre" runat="server" CssClass="form-select"  AutoPostBack="true">
                  ...
                  <asp:ListItem Value="Travel">Travel</asp:ListItem>
                            ...
                            <!-- Pricing and Stock -->
                            <h5 class="section-title">Inventory & Pricing</h5>
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    <label for="txtstocks" class="form-label">Quantity in Stock</label>
                                    <div class="input-group">
